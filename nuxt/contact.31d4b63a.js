import{u as I}from"./moment.1bb95193.js";import{B as y,P as F,C as $,m as v,q as x,D as _,E as B,_ as R,J as P,u as T,K as L,L as Y,r as d,s as i,t as u,v as o,x as b,M as h,Q as m,z as C,A,R as E}from"./entry.43e48f2b.js";import{s as H}from"./index.3348ed05.js";import"./vue.f36acd1f.7c570dc8.js";/* empty css                   */var N=function(e){var a=e.dt;return`
.p-textarea {
    font-family: inherit;
...
`)},J={root:function(e){e.instance;var a=e.props;return["p-floatlabel",{"p-floatlabel-over":a.variant==="over","p-floatlabel-on":a.variant==="on","p-floatlabel-in":a.variant==="in"}]}},K=y.extend({name:"floatlabel",theme:q,classes:J}),W={name:"BaseFloatLabel",extends:$,props:{variant:{type:String,default:"over"}},style:K,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},k={name:"FloatLabel",extends:W,inheritAttrs:!1};function X(t,e,a,l,r,n){return v(),x("span",_({class:t.cx("root")},t.ptmi("root")),[B(t.$slots,"default")],16)}k.render=X;const G=t=>(C("data-v-4c73924b"),t=t(),A(),t),O={class:"content"},Z={class:"section-header"},aa={action:"https://fabform.io/f/tX2SW6Q",method:"post",class:"form",target:"_blank"},ta={for:"name"},ea={for:"email"},la={for:"description"},na=G(()=>i("div",{class:"placeholder",style:{width:"100%","min-height":"50px",display:"block"}},null,-1)),oa={__name:"contact",setup(t){P(),T(),L();const e=Y(),a=d(null),l=d(""),r=d(""),n=d(""),z=()=>{a.value.click(),l.value="",r.value="",n.value=""};return I({title:()=>"Nico Thuniot | "+e.t("menu.contact")}),(p,s)=>{const g=E,f=k,V=w,S=H;return v(),x("div",O,[i("div",Z,u(p.$t("menu.contact")),1),i("form",aa,[o(f,{variant:"in"},{default:b(()=>[o(g,{id:"name",style:{width:"100%"},modelValue:h(l),"onUpdate:modelValue":s[0]||(s[0]=c=>m(l)?l.value=c:null),name:"name",variant:"filled"},null,8,["modelValue"]),i("label",ta,u(p.$t("contact.name")),1)]),_:1}),o(f,{variant:"in"},{default:b(()=>[o(g,{id:"email",style:{width:"100%"},modelValue:h(r),"onUpdate:modelValue":s[1]||(s[1]=c=>m(r)?r.value=c:null),name:"email",variant:"filled"},null,8,["modelValue"]),i("label",ea,u(p.$t("contact.email")),1)]),_:1}),o(f,{variant:"in"},{default:b(()=>[o(V,{id:"description",name:"description",modelValue:h(n),"onUpdate:modelValue":s[2]||(s[2]=c=>m(n)?n.value=c:null),variant:"filled",style:{width:"100%",resize:"none"},rows:"5",cols:"30"},null,8,["modelValue"]),i("label",la,u(p.$t("contact.description")),1)]),_:1}),o(S,{label:p.$t("contact.submit"),onClick:z},null,8,["label"]),i("input",{type:"submit",ref_key:"submit",ref:a,value:"Submit",style:{display:"none"}},null,512)]),na])}}},da=R(oa,[["__scopeId","data-v-4c73924b"]]);export{da as default};
