import{B as $,C as w,m as o,q as a,D as t,E as p,y as k,t as m,F as u,G as I,H as S,I as z,s,_ as j,J as N,u as D,K,r as b,L as M,M as y,v as g,x as f,N as V,z as _,A,O as E}from"./entry.43e48f2b.js";import{h as L,u as q}from"./moment.1bb95193.js";/* empty css                   */import"./vue.f36acd1f.7c570dc8.js";var J=function(r){var n=r.dt;return`
.p-progressbar {
    position: relative;
    overflow: hidden;
...
`)},te={root:"p-card p-component",header:"p-card-header",body:"p-card-body",caption:"p-card-caption",title:"p-card-title",subtitle:"p-card-subtitle",content:"p-card-content",footer:"p-card-footer"},re=$.extend({name:"card",theme:ne,classes:te}),ie={name:"BaseCard",extends:w,style:re,provide:function(){return{$pcCard:this,$parentInstance:this}}},C={name:"Card",extends:ie,inheritAttrs:!1};function oe(e,r,n,v,h,l){return o(),a("div",t({class:e.cx("root")},e.ptmi("root")),[e.$slots.header?(o(),a("div",t({key:0,class:e.cx("header")},e.ptm("header")),[p(e.$slots,"header")],16)):u("",!0),s("div",t({class:e.cx("body")},e.ptm("body")),[e.$slots.title||e.$slots.subtitle?(o(),a("div",t({key:0,class:e.cx("caption")},e.ptm("caption")),[e.$slots.title?(o(),a("div",t({key:0,class:e.cx("title")},e.ptm("title")),[p(e.$slots,"title")],16)):u("",!0),e.$slots.subtitle?(o(),a("div",t({key:1,class:e.cx("subtitle")},e.ptm("subtitle")),[p(e.$slots,"subtitle")],16)):u("",!0)],16)):u("",!0),s("div",t({class:e.cx("content")},e.ptm("content")),[p(e.$slots,"content")],16),e.$slots.footer?(o(),a("div",t({key:1,class:e.cx("footer")},e.ptm("footer")),[p(e.$slots,"footer")],16)):u("",!0)],16)],16)}C.render=oe;const ae=e=>(_("data-v-36ca4730"),e=e(),A(),e),se={class:"content"},le={class:"section-header"},ce={class:"description"},pe={style:{"text-align":"justify"}},de={class:"section-header"},me={class:"skill-wrapper"},ue={class:"tech"},ve=ae(()=>s("div",{class:"placeholder",style:{width:"100%","min-height":"50px",display:"block"}},null,-1)),he={__name:"about",setup(e){N(),D(),K();const r=b(L().diff("2003-02-12","years")),n=M(),v=b([{name:"HTML",icon:"uim:html5",color:"#E34F26",progress:100},{name:"CSS",icon:"ion:logo-css3",color:"#1572B6",progress:100},{name:"JavaScript",icon:"bx:bxl-javascript",color:"#F0DB4F",light:!0,progress:100},{name:"TypeScript",icon:"file-icons:typescript",color:"#3178C6",progress:80},{name:"Vue.js",icon:"file-icons:vue",color:"#41B883",progress:80},{name:"Nuxt.js",icon:"tabler:brand-nuxt",color:"#00D8FF",progress:80},{name:"Quasar",icon:"file-icons:quasar",color:"#FFA000",progress:80},{name:"Express",icon:"simple-icons:express",color:"#3498DB",progress:90},{name:"MySQL",icon:"lineicons:mysql",color:"#4479A1",progress:90},{name:"Flutter",icon:"file-icons:flutter",color:"#4285F4",progress:50},{name:"C#",icon:"devicon-plain:csharp",color:"#178600",progress:80},{name:"Java",icon:"hugeicons:java",color:"#ED8B00",progress:70},{name:"Bootstrap",icon:"cib:bootstrap",color:"#7952B3",progress:50}]),h=b([{status:"journey-start",date:"2018"},{status:"htl-donaustadt",date:"2018-2023"},{status:"current",date:"2024"}]),l=(c,i)=>i.progress-c.progress;return q({title:()=>"Nico Thuniot | "+n.t("menu.about")}),(c,i)=>{const T=C,F=B,O=E,P=x;return o(),a("div",se,[s("div",le,m(c.$t("menu.about")),1),s("div",ce,m(c.$t("profile.description",{age:y(r)})),1),g(F,{value:y(h),class:"customized-timeline"},{content:f(d=>[g(T,{class:"mt-4"},{title:f(()=>[k(m(c.$t(`profile.${d.item.status}.title`)),1)]),subtitle:f(()=>[k(m(d.item.date),1)]),content:f(()=>[s("p",pe,m(c.$t(`profile.${d.item.status}.desc`)),1)]),_:2},1024)]),_:1},8,["value"]),s("div",de,m(c.$t("menu.skills")),1),s("div",me,[(o(!0),a(S,null,z(y(v).sort(l),(d,ge)=>(o(),a("div",{class:"tech-item",key:d.icon,style:V(`--tech-color: ${d.color};`)},[s("div",ue,[g(O,{name:d.icon},null,8,["name"]),s("span",null,m(d.name),1)]),g(P,{value:d.progress},null,8,["value"])],4))),128))]),ve])}}},$e=j(he,[["__scopeId","data-v-36ca4730"]]);export{$e as default};
